...
var broadcast_1 = require("./models/broadcast");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                one = 1;
                return [4 /*yield*/, event_1.EventModel.findOne({}, {}, { sort: { eventId: -1 } }).sort('desc')];
            case 2:
                lastEvent = _a.sent();
                if (lastEvent) {
...
app.post('/broadcast', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var evId, eventRegs, e_34;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 3:
                                    ...
                                    participant = new broadcast_1.Broadcast({
                                        "eventId": req.body.eventId,
...
app.post('/getterForBroadcast', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var username, broadcast, e_35;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                username = req.body.Username;
                return [4 /*yield*/, broadcast_1.Broadcast.find({ emailUsername: username }, { _id: 0, __v: 0 })];
            case 1:
                broadcast = _a.sent();
                return [4 /*yield*/, broadcast_1.Broadcast.deleteMany({ emailUsername: username })];
            case 2:
                _a.sent();
...
app.put('/eventRegistrations/updateParticipant/:eventRegId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var verify, evRegId, eventReg, ship, user, e_36;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, authentication_controller_1.Auth.Authorize(req, res, "admin")];
            case 1:
...
app.post('/locationRegistrations/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var locationRegistration, val, locationReg, one, lastRegistration, e_37;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
...
app.get('/locationRegistrations/getLive/:eventId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var evId, eventRegistrations, fewRegistrations_1, i, e_38;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
app.get('/locationRegistrations/getReplay/:eventId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var evId, eventRegistrations, shipLocations_1, e_39;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
app.get('/locationRegistrations/getScoreboard/:eventId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var evId, eventRegistrations, scores_1, i, e_40;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
