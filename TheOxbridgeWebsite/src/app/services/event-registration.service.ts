...
export class EventRegistrationService {
  ...
  public SignUpForEvent(shipId: number, teamName: string, eventCode: string): Observable<EventRegistration> {
    ...
    return this.http.post<EventRegistration>(this.eventRegistrationUrl + 'signUp', {
      shipId,
      teamName,
      eventCode
    }, httpOptions).pipe(map(eventReg => eventReg));
  }
  ...
  public getParticipants(eventId: number): Observable<Participant[]> {
    return this.http.get<Participant[]>(this.eventRegistrationUrl + 'getParticipants/' + eventId).pipe(map(participants => participants));
  }
  ...
  public addParticipant(participant): Observable<Participant> {
    ...
    return this.http.post<Participant>(this.eventRegistrationUrl + 'addParticipant', participant, httpOptions).pipe(map(participant => participant));
  }
  ...
  public updateParticipant(participant): Observable<Participant> {
    ...
    return this.http.put<Participant>(this.eventRegistrationUrl + 'updateParticipant/' + participant.eventRegId, participant, httpOptions).pipe(map(participant => participant));
  }
  ...
  public deleteParticipant(eventRegId): Observable<EventRegistration> {
    ...
    return this.http.delete<EventRegistration>(this.eventRegistrationUrl + eventRegId, httpOptions).pipe(map(eventRegistration => eventRegistration));
  }
  ...
  public unSubscribeToEvent(eventRegId): Observable<EventRegistration> {
    ...
    return this.http.delete<EventRegistration>(this.eventRegistrationUrl + eventRegId, httpOptions).pipe(map(eventReg => eventReg));
  }
}
